...
class RoughCluster():
    def __init__(self, config):
        ...
        self.log = root_log.StandardLogger("UnsupervisedClustering")
    ...
    def unsupervised_clusters(
            self, n_of_clusters, img_location, img_size, masked_img_dir):
        ...
        self.log.info(
            "Input image resized and configured for clustering computation.")
        ...
        for n, ax in enumerate(axes.flatten()):
            ...
            # Disabling pixels of certain type
